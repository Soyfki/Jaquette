...
**Suivi de la reprise :** 0.1 validée et intégrée par la PR 10 ; **0.2 — Reproduire la base** validée, avec [preuves et suivi de fusion dans la PR 11](https://github.com/Soyfki/Jaquette/pull/11). Runtime fixé, installation propre depuis le lockfile, six références canoniques, contrôles locaux et CI Chrome sont qualifiés aux SHA consignés. **0.3 est en validation dans la PR 9 reprise**, après intégration de main 0.2. La [campagne commune](docs/validation/0.3-correctifs-prototype/CHECKLIST.md) exige deux conclusions distinctes au même SHA : correctifs 0.3 et revalidation historique 1.4.2. Aucun des deux lots n’est acquis sans les observations humaines obligatoires ; aucune fusion ni étape suivante à ce stade.
...
Les lots de reprise **0.1 — Harmoniser les sources** et **0.2 — Reproduire la base** sont validés ; leurs décisions et preuves sont consignées dans les PR 10 et 11 liées à leurs dossiers. **Action en cours : validation 0.3 et revalidation historique 1.4.2 dans PR 9**, avec observations humaines encore requises. 0.4, l’ancienne 2.1 et la nouvelle étape 1 ne démarrent pas. Aucun numéro de cette feuille de route ne vaut validation automatique d’une livraison.
