...
- Les quatre rôles, dont Chef d’équipe et Admin Maison, et les correctifs 1.4.2 sont présents dans la [PR 9](https://github.com/Soyfki/Jaquette/pull/9), branche codex/phase-1-4-2-team-lead-admin-variants. Le SHA historique 5cabbb016d3ce5480b165512c1aa7814b8367802 est repris pour 0.3 après intégration de main 0.2 ; la PR consigne le nouveau SHA de recette. Ils ne sont pas sur main tant que cette PR n’est pas fusionnée.
...
- La nouvelle étape 0 est distincte de l’ancienne phase 0 acquise. Les lots **0.1 — Harmoniser les sources** et **0.2 — Reproduire la base** sont validés ; preuves et SHA qualifiés dans les PR 10 et [PR 11](https://github.com/Soyfki/Jaquette/pull/11). **0.3 — Corriger les défauts du prototype** est en validation dans PR 9, avec [recette 0.3 et revalidation 1.4.2 distinctes](docs/validation/0.3-correctifs-prototype/CHECKLIST.md). Les deux restent non acquises tant que les observations obligatoires manquent ; 0.4 et les étapes suivantes ne commencent pas ici.
