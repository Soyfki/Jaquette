...
La nouvelle étape 0 est distincte de l’ancienne phase 0 acquise. Les lots 0.1 et **0.2 — Reproduire la base** sont validés ; la [campagne 0.2](docs/validation/0.2-base-reproductible/README.md) et la [PR 11](https://github.com/Soyfki/Jaquette/pull/11) consignent les preuves et SHA contrôlés. **0.3 — Corriger les défauts du prototype** est en validation dans PR 9 reprise depuis son SHA historique ci-dessus, après intégration de main 0.2. La [recette](docs/validation/0.3-correctifs-prototype/CHECKLIST.md) distingue 0.3 et revalidation 1.4.2 ; les deux attendent les observations humaines obligatoires et restent non acquises. 0.4 et les étapes suivantes ne démarrent pas. La version reste **0.0.0**.
