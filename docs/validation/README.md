...
La campagne propre à la page exécutable du design system est décrite dans [`1.1-design-system.md`](1.1-design-system.md). La campagne du lot 1.4.1 consacré au rôle simulé et à la variante Réviseur est décrite dans [`1.4-role-variants.md`](1.4-role-variants.md). La campagne distincte du lot 1.4.2 consacré aux variantes Chef d’équipe et Admin Maison est décrite dans [`1.4.2-team-lead-admin-variants.md`](1.4.2-team-lead-admin-variants.md).
