...
Les résultats PASS/FAIL/BLOCKED, observations et preuves sont publiés à SHA fixe dans la PR. Avant retour humain : **0.3 BLOQUÉE / NO-GO ; 1.4.2 BLOQUÉE / NO-GO**. Aucune dette admissible ne dispense d’un critère obligatoire. Aucune acquisition de l’ancienne 1.4/phase 1/1.4.3 ni démarrage de 0.4.
