...
## B03-7 — Pastilles et pseudo-logo J non circulaires

Pendant la reprise Admin, l’utilisateur signale que les cercles de couleur du design system et le J ont un côté gauche plat, et demande des cercles parfaits. Le CSS confirme des rayons asymétriques : 45 % / 55 % pour les pastilles, 46 % / 54 % / 60 % / 40 % pour les deux usages du J. Les largeurs et hauteurs sont déjà égales. Correction : rayon uniforme de 50 % et interdiction du rétrécissement flex des pastilles et du J d’en-tête ; même correction du J de la carte Connexion pour conserver la cohérence.

La campagne locale Admin seule au SHA `0644a30a40595b2233a1792dddc7b74343546f1c` est interrompue avant toute nouvelle modification, sans revendiquer de résultat complet. Une nouvelle campagne complète est exigée au SHA réunissant B03-6 et B03-7. T13 vérifie les dimensions et rayons calculés puis les captures aux deux formats. H03-4 recueille la nouvelle observation des cercles ; aucun test de snapshots ni dépendance n’est ajouté pour ces corrections CSS.

## Clôture des reprises visuelles — 18 septembre 2026

Au SHA `28cb5d943e0617de0b6fec9e50e76ca3b54c9c51`, les campagnes techniques locale et CI sont PASS ; T12/T13 confirment alignements, espacements et cercles aux deux formats. L’utilisateur confirme H14-6 PASS, H14-10 PASS et H03-4 PASS : B03-6 et B03-7 sont clos. Le [rapport](VALIDATION_REPORT.md) conserve les observations exactes et les deux décisions VALIDÉE / GO. Les descriptions précédentes retracent les étapes de correction ; elles ne désignent plus de retour en attente.
