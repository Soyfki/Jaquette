...
| Arabe | EPUB 3.0 reflowable ; 3 éléments de spine ; 1 feuille de style ; 2 images valides ; aucune ressource chiffrée | Navigation EPUB 3 et NCX ; 8 destinations cumulées, toutes résolues | `dc:language=ar`, progression du spine `rtl`, balisage RTL et plus de 23 000 caractères arabes | 0 fatal, 0 erreur, 0 avertissement | Contrôle humain dans Thorium Reader EDRLab 3.4.0 : glyphes arabes lisibles et liés, sans rectangles ; direction RTL confirmée ; navigation entre plusieurs sections réussie. |
...
- SumatraPDF 3.6.1 affiche l’échantillon arabe sous forme de rectangles malgré une archive valide et un rendu correct lors du contrôle humain dans Thorium Reader EDRLab 3.4.0. Cette différence reste classée comme une incompatibilité de rendu connue de SumatraPDF pour l’arabe, et non comme un défaut démontré de l’EPUB.
- L’agent IA n’a pas réussi à utiliser Thorium Reader EDRLab 3.4.0 dans son environnement de contrôle, le lecteur s’étant fermé avant l’affichage du livre. Cet incident d’outillage n’a pas été reproduit lors du contrôle humain : l’utilisateur a ouvert et parcouru manuellement les EPUB dans Thorium le 23 août 2026.
- Le contrôle d’écoute humain confirme les résultats suivants : **SFX** : heurtoir clairement identifiable et conforme ; **Ambiance** : pluie conforme, niveau perçu légèrement faible mais réglable par occurrence ; **Musique** : conforme à sa catégorie, adéquation artistique imparfaite avec la scène mais acceptable comme donnée technique.
